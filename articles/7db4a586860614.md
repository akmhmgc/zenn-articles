...
## 結論：scopeを使うと内部的にクラスメソッドが定義される＋他にも色々やっている
[Ruby用語集](https://docs.ruby-lang.org/ja/3.1/doc/glossary.html)によるとクラスメソッドとはそのオブジェクトの特異クラスのインスタンスメソッドのことです。
...
つまり特異クラス内でインスタンスメソッドを定義しているのでscopeを定義したクラスから見るとクラスメソッドが定義されたということに他なりません。
